...
import {
  ...
  testimonialList,
  seoContent,
} from "../../constants/structuralhyderabad.constant";
...
export default function Structural() {
  ...
  return (
    <HomeLayout>
      <Head>
        <title>
        Structural Consultants in Hyderabad | Structural Design Company Hyderabad
          - Sqft Expert
        </title>
        ...
        <link
          rel="canonical"
          href="https://sqft.expert/structural-consultants-hyderabad"
        />
      </Head>
