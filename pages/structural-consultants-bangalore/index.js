...
import {
  ...
  testimonialList,
  seoContent,
} from "../../constants/structural.constant";
...
export default function Structural() {
  ...
  return (
    <HomeLayout>
      <Head>
        <title>
        Structural Consultants in Bangalore | Structural Design Company Bangalore
          - Sqft Expert
        </title>
        <meta name="description" content="We have qualified structural consultants and structural engineers in bangalore, who can help you with drafting and designing a structures." />
        <link rel="icon" href="/favicon.ico" />
        <link
          rel="canonical"
          href="https://sqft.expert/structural-consultants-bangalore"
        />
      </Head>
