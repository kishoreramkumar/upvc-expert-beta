...
import {
  ...
  testimonialList,
  seoContent,
} from "../../constants/structuralchennai.constant";
...
export default function Structural() {
  ...
  return (
    <HomeLayout>
      <Head>
        <title>
        Structural Consultants in Chennai | Structural Design Company Chennai
          - Sqft Expert
        </title>
        ...
        <link
          rel="canonical"
          href="https://sqft.expert/structural-consultants-Chennai"
        />
      </Head>
