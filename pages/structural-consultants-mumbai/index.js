...
import {
  ...
  testimonialList,
  seoContent,
} from "../../constants/structuralmumbai.constant";
...
export default function Structural() {
  ...
  return (
    <HomeLayout>
      <Head>
        <title>
        Structural Consultants in Mumbai | Structural Design Company Mumbai
          - Sqft Expert
        </title>
        ...
        <link
          rel="canonical"
          href="https://sqft.expert/structural-consultants-mumbai"
        />
      </Head>
