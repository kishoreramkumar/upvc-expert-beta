...
import {
  ...
  testimonialList,
  seoContent,
} from "../../constants/plan-approval.constant";
...
export default function PlanApproval() {
  ...
  return (
    <HomeLayout>
      <Head>
        <title>
          BBMP Building Plan Approval in Bangalore Starts at Rs 5000 - Sqft
          Expert
        </title>
        ...
        <link
          rel="canonical"
          href="https://sqft.expert/house-plan-approvals-bangalore"
        />
      </Head>
      ...
      <ConstructionServiceAd
        ...
        sideBanner={
          "/assets/images/plan-approval/BBMPPanchayatiApprovalsBangalore.svg"
        }
      />
      <Testimonials
