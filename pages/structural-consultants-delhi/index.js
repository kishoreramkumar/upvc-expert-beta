...
import {
  ...
  testimonialList,
  seoContent,
} from "../../constants/structuraldelhi.constant";
...
export default function Structural() {
  ...
  return (
    <HomeLayout>
      <Head>
        <title>
        Structural Consultants in Delhi | Structural Design Company Delhi
          - Sqft Expert
        </title>
        ...
        <link
          rel="canonical"
          href="https://sqft.expert/structural-consultants-delhi"
        />
      </Head>
