...
import {
  ...
  testimonialList,
  seoContent,
} from "../../constants/constructioncompany.constants.js";
  ...
  return (
    <LPLayout>
      <>
        <Head>
          <title>
          Construction Company in Bangalore | House Construction Packages
          ...
          <link rel="canonical" href="https://sqft.expert/construction-company" />
        </Head>
        <LandingSection
