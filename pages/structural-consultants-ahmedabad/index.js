...
import {
  ...
  testimonialList,
  seoContent,
} from "../../constants/structuralahmedabad.constant";
...
export default function Structural() {
  ...
  return (
    <HomeLayout>
      <Head>
        <title>
        Structural Consultants in Ahmedabad | Structural Design Company Ahmedabad
          - Sqft Expert
        </title>
        ...
        <link
          rel="canonical"
          href="https://sqft.expert/structural-consultants-ahmedabad"
        />
      </Head>
