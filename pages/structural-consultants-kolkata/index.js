...
import {
  ...
  testimonialList,
  seoContent,
} from "../../constants/structuralkolkata.constant";
...
export default function Structural() {
  ...
  return (
    <HomeLayout>
      <Head>
        <title>
        Structural Consultants in Kolkata | Structural Design Company Kolkata
          - Sqft Expert
        </title>
        ...
        <link
          rel="canonical"
          href="https://sqft.expert/structural-consultants-kolkata"
        />
      </Head>
