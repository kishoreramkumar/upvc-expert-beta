...
export const landingPageConstant = {
  title: `Duplex House Construction Cost in Bangalore <span class="primary"></span>`,
  description: `Quality Homes Come from Experts, and We draft the best designs for our customers. Know the <span class="bold"> <h1 class="inherit">Duplex House Cost in Bangalore</h1></span>`,
    ...
    productData: [
      ...
      },
      {
        ...
        data: [
          ...
          "Cement(Ramco, Dalmia, Penna, Birla or equivalent of Grade –53 & 43)",
      ...
      },
      {
        ...
        data: [
          ...
          "Wall tiles shall be fixed with tile adhesive. Joints shall be cleaned thoroughly and grouted with site-made grout.",
          "If granite is used – Granite used should have a minimum thickness of 20 mm.",
          "Skirting shall be of tiles/granite. The height of skirting shall not be less than 75mm",
      ...
      },
      {
        ...
        data: [
          ...
          "Parapet wall shall be provided with a height of 3’6” and 100mm thick. Buttress shall be provided at every 3 m (10 feet) of length.",
...
export const seoContent = [
  {
    title: "Construction Cost for Duplex House in Bangalore",
    content: "We do building construction in bangalore provides quality homes with On-time delivery. Contact us today to get construction cost of duplex house.",
    expandContent: "",
  },
];
