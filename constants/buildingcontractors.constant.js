...
export const landingPageConstant = {
  title: `Building Contractors in Bangalore <span class="primary"></span>`,
  description: `Quality Homes Come from Experts, and We draft the best designs for our customers. We are a <span class="bold">best  <h1 class="inherit">Civil Contractors in Bangalore</h1></span>`,
...
export const seoContent = [
  {
    title: "Construction Contractors in Bangalore",
    content: "We are the house construction contractors in bangalore provides quality homes with On-time delivery. Sqft.expert is the best building contractors in bangalore",
    expandContent: "",
  },
];
