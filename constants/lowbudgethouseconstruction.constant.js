...
export const landingPageConstant = {
  title: `Low Budget House Construction in Bangalore<span class="primary"></span>`,
  description: `Quality Homes Come from Experts, and We draft the best designs for our customers. We build <span class="bold">best  <h1 class="inherit">Low Budget House Construction</h1></span>`,
...
export const seoContent = [
  {
    title: "Low Budget Home Construction",
    content: "We do building construction in bangalore provides quality homes with On-time delivery. Consult our team and get low budget house construction cost.",
    expandContent: "",
  },
];
