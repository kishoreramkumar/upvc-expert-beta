...
export const landingPageConstant = {
  title: `House Construction in Bangalore <span class="primary"></span>`,
  description: `Quality Homes Come from Experts, and We draft the best designs for our customers. We build <span class="bold">best  <h1 class="inherit">Home Construction in Bangalore</h1></span>`,
...
export const seoContent = [
  {
    title: "Build a Home in Bangalore",
    content: "We do building construction in bangalore provides quality homes with On-time delivery. Sqft.expert is the best building construction in bangalore",
    expandContent: "",
  },
];
